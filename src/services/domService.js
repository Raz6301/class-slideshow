...
export const SIGN_UP_EMAIL_ERROR = document.getElementById("signup-email-error");
export const SIGN_UP_PASSWORD_FIELD = document.getElementById("signup-password-field");
export const SIGN_UP_PASSWORD_ERROR = document.getElementById("signup-password-error");
export const SIGN_UP_PHONE_FIELD = document.getElementById("signup-phone-field");
export const SIGN_UP_PHONE_ERROR = document.getElementById("signup-phone-error");
export const SIGN_UP_NAME_FIELD = document.getElementById("signup-name-field");
export const SIGN_UP_NAME_ERROR = document.getElementById("signup-name-error");
...
export const SIGN_UP_LASTNAME_ERROR = document.getElementById("signup-namelast-error");
export const SIGN_UP_STATE_FIELD = document.getElementById("signup-state-field");
export const SIGN_UP_STATE_ERROR = document.getElementById("signup-state-error");
export const SIGN_UP_COUNTRY_FIELD = document.getElementById("signup-country-field");
export const SIGN_UP_COUNTRY_ERROR = document.getElementById("signup-country-error");
export const SIGN_UP_CITY_FIELD = document.getElementById("signup-city-field");
export const SIGN_UP_CITY_ERROR = document.getElementById("signup-city-error");
export const SIGN_UP_STREET_FIELD = document.getElementById("signup-street-field");
export const SIGN_UP_STREET_ERROR = document.getElementById("signup-street-error");
export const SIGN_UP_HOUSE_FIELD = document.getElementById("signup-house-field");
export const SIGN_UP_HOUSE_ERROR = document.getElementById("signup-house-error");
export const SIGN_UP_ZIP_FIELD = document.getElementById("signup-zip-field");
export const SIGN_UP_ZIP_ERROR = document.getElementById("signup-zip-error");
export const SIGN_UP_REPASSWORD_FIELD = document.getElementById("signup-renterpassword-field");
export const SIGN_UP_REPASSWORD_ERROR = document.getElementById("signup-renterpassword-error");
export const SIGN_UP_ISBUSINESS = document.getElementById("bsClient");
